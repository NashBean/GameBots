...
const int PLATINUM_RIFT_E2_MINOR_VERSION = 8;
//-------------------------------------------------------------------------
            ...
            if(zone[i].hasMyPod(my_id))
            {
             ...
             for(int c=0; c<zonelink.size(); c++) // foe I can take with platium
             {
                    ...
                    && (zone[zonelink[c].zone2].foeCount(my_id)<(zone[zonelink[c].zone1].hasMyPod(my_id)))) 
                 {
                    ...
                    && (zone[zonelink[c].zone2].foeCount(my_id)>=(zone[zonelink[c].zone1].hasMyPod(my_id)))) 
                {
                   zone[zonelink[c].zone1].demand =  foe_adj+zone[zonelink[c].zone2].foeCount(my_id);        
                }
             }
             ...
             for(int c=0; c<zonelink.size(); c++)// foe I can take
             {
                 ...
                 else if(zone[zonelink[c].zone2].ownerId!=my_id)
                 {
                     zone[zonelink[c].zone1].demand = zone[zonelink[c].zone2].foeCount(my_id);
                 }
             }
             ...
             for(int c=0; c<zonelink.size(); c++)//need more pods in zone2
             {
                 ...
                 && zone[zonelink[c].zone1].hasMyPod(my_id)>(pod_limit+pod_limit_buffer)) 
                 {
                     if(!result.empty()) result=result+" "+to_string(zone[zonelink[c].zone1].hasMyPod(my_id)-zone[zonelink[c].zone1].demand) +" ";
                     else result=to_string(zone[zonelink[c].zone1].hasMyPod(my_id)-zone[zonelink[c].zone1].demand) +" ";
                     result = result +to_string(zonelink[c].zone1)+" "+to_string(zonelink[c].zone2);
                 }
             }
