...
/*/
    ...
    int turn_around_angle = 170;//
    int turn_around_thrust = 7;
    int u_turn_speed = 125;// +/- 25  //175; 
    int u_turn_angle = 140;// +/- 20    //110;
    int u_turn_thrust = 14;
    int drift_speed = 150;// +/- 100    //200;
    int drift_angle = 75;// +/- 15  //50;
    int drift_thrust = 24;
    int hard_turn_speed = 175;// +/- 50  //225;
    int hard_turn_angle = 42;//40;
    int hard_turn_thrust = 41;
    int light_turn_speed = 400;//550;
    int light_turn_angle = 35;//7;
    int light_turn_thrust = 74;
    int top_speed = 850;//777;
//*/    
    int angle=0;
    int skid=0;
    bool saveToFile()
...
struct Ride
{
    ...
    string getThrustResult()
    {
        ...
        if(ed < bump_distance)
        { 	bump_opp(); }
        else if(boost && cp.angl<1 && cp.dist>3500)
        {	reset_thrust=thrust; thrust=1000; boost=false;  }
